...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Integer[] numerosSelectionSort = gerarVetorAleatorio(n); //vetorDeNumeros(); 
        ...
        System.out.println("\nComparacoes Selection:"+selectionSort.getContaComparacoes());
        ...
        System.out.println("\nComparacoes Bubble Sort: " +bubbleSort.getContaComparacoes());
        ...
        System.out.println("\nComparacoes ISort: " +insertionSort.getContaComparacoes());
